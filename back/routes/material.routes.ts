...
import { createMaterial, deleteMaterial, getAllMaterialAtelier, getAllMaterialSg, getAllMaterials, getMaterialByCategory, getMaterialById, getStoreMateriel, statusMateriel, updateMaterial } from "../controllers/material.controller";
...
/**
 * @swagger
 * /api/materials/atelier:
 *   get:
 *     summary: Récupérer la liste des matériels de l'atelier
 *     tags: [Materials]
 *     responses:
 *       200:
 *         description: Liste des matériels de l'atelier
 *         content:
 *           application/json:
 *             schema:
 *               type: array
 ...
 * /api/materials/store:
 *   get:
 *     summary: Récupérer la liste des matériels du magasin
 *     tags: [Materials]
 *     responses:
 *       200:
 *         description: Liste des matériels du magasin
 *         content:
 *           application/json:
 *             schema:
 *               type: array
 ...
 *                 $ref: '#/components/schemas/Material'
 */
materialRouter.get('/store', getStoreMateriel);
 ...
 *     responses:
 *       200:
 *         description: Liste des matériels des services généraux
 *         content:
 *           application/json:
 *             schema:
 *               type: array
 ...
 * /api/materials:
 *   get:
 *     summary: Récupérer la liste des matériels 
 *     tags: [Materials]
 *     responses:
 *       200:
 ...
 */
materialRouter.put('/', validate(materialSchema), updateMaterial);
