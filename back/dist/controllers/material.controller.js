...
export const getAllMaterialAtelier = async (req, res, next) => {
    try {
...
export const getAllMaterialSg = async (req, res, next) => {
    try {
        const materials = await prisma.material.findMany({
            where: { serviceId: 2 },
        });
...
export const getMaterialByCategory = async (req, res, next) => {
...
export const statusMateriel = async (req, res, next) => {
